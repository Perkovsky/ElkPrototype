...
namespace Serilog.Core
{
    ...
    public sealed class Logger : ILogger, ILogEventSink, IDisposable
    {
        ...
        /// <param name="propertyValue">Object positionally formatted into the message template.</param>
        [MessageTemplateFormatMethod("messageTemplate")]
        public void Write<T>(DateTime date, LogEventLevel level, string messageTemplate, T propertyValue)
        {
            // Avoid the array allocation and any boxing allocations when the level isn't enabled
            if (IsEnabled(level))
            {
                Write(date, level, messageTemplate, new object[] { propertyValue });
            }
        }
        ...
        /// <param name="propertyValues"></param>
        [MessageTemplateFormatMethod("messageTemplate")]
        public void Write(DateTime date, LogEventLevel level, string messageTemplate, params object[] propertyValues)
        {
            Write(date, level, (Exception)null, messageTemplate, propertyValues);
        }
        ...
        /// <param name="propertyValues"></param>
        [MessageTemplateFormatMethod("messageTemplate")]
        public void Write(LogEventLevel level, Exception ex, string messageTemplate, params object[] propertyValues)
        {
        }
        ...
        [MessageTemplateFormatMethod("messageTemplate")]
        public void Write(DateTime date, LogEventLevel level, Exception exception, string messageTemplate, params object[] propertyValues)
        {
            ...
            var logEvent = new LogEvent(new DateTimeOffset(date), level, exception, parsedTemplate, boundProperties);
            Dispatch(logEvent);
        }
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        public void Information<T>(DateTime date, string messageTemplate, T propertyValue)
        {
            Write(date, LogEventLevel.Information, messageTemplate, propertyValue);
        }
